...
import pandas as pd
from variables import connectionFeedbacks, folderIdAprendriz, smileFacePath, rocketPath, autocompletarTutor,page_icon
...
def run():
    ...
    st.image("./images/fp-conecta.png", width=300)
...
def create_gsheets_connection():
    try:
        conn = st.connection(connectionFeedbacks, type=GSheetsConnection)
        return conn
