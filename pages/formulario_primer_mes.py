...
from variables import connectionFeedbacks, worksheetFormulario1Mes,autocompletarTutor,autocompletarNombre,page_icon
...
pageOneQuestions = range(0, 4)  # Questions for page 1
pageTwoQuestions = range(4, 8)  # Questions for page 2
...
def save_to_google_sheet(data):
    ...
    existing_data = conn.read(worksheet=worksheetFormulario1Mes)
    ...
    conn.update(worksheet=worksheetFormulario1Mes, data=updated_data)
